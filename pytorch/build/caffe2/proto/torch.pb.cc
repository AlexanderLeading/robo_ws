...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 7, 19, sizeof(::torch::TensorDef)},
  { 26, 34, sizeof(::torch::AttributeDef)},
  { 37, 45, sizeof(::torch::ParameterDef)},
  { 48, 62, sizeof(::torch::ModuleDef)},
  { 71, 77, sizeof(::torch::LibDef)},
  { 78, 88, sizeof(::torch::ModelDef)},
};
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "h.RecordRef\022\016\n\006device\030\007 \001(\t\"6\n\014Attribute"
      "Def\022\014\n\004type\030\001 \002(\t\022\014\n\004name\030\002 \002(\t\022\n\n\002id\030\003 "
      "\002(\003\"B\n\014ParameterDef\022\021\n\tis_buffer\030\001 \001(\010\022\021"
      "\n\ttensor_id\030\002 \001(\003\022\014\n\004name\030\003 \001(\t\"\302\002\n\tModu"
      "leDef\022$\n\nsubmodules\030\001 \003(\0132\020.torch.Module"
      "Def\022+\n\021torchscript_arena\030\002 \001(\0132\020.torch.R"
      "ecordRef\022#\n\013caffe2_nets\030\003 \003(\0132\016.caffe2.N"
      "etDef\022&\n\014pickle_arena\030\004 \001(\0132\020.torch.Reco"
      "rdRef\022#\n\tcpp_arena\030\005 \001(\0132\020.torch.RecordR"
      "ef\022\'\n\nparameters\030\006 \003(\0132\023.torch.Parameter"
      "Def\022\014\n\004name\030\007 \001(\t\022\020\n\010optimize\030\010 \001(\010\022\'\n\na"
      "ttributes\030\t \003(\0132\023.torch.AttributeDef\"5\n\006"
      "LibDef\022+\n\021torchscript_arena\030\001 \001(\0132\020.torc"
      "h.RecordRef\"\250\001\n\010ModelDef\022\025\n\rproto_versio"
      "n\030\001 \001(\003\022%\n\013main_module\030\002 \001(\0132\020.torch.Mod"
      "uleDef\022\025\n\rproducer_name\030\003 \001(\t\022\030\n\020produce"
      "r_version\030\004 \001(\t\022!\n\007tensors\030\005 \003(\0132\020.torch"
      ".TensorDefJ\004\010\t\020\nR\004libs*(\n\014ProtoVersion\022\030"
      "\n\024PROTO_VERSION_NEWEST\020\003"
  };
...
void TensorDef::SharedCtor() {
  ...
  ::memset(&data_, 0, static_cast<size_t>(
      ...
      reinterpret_cast<char*>(&data_)) + sizeof(data_type_));
}
