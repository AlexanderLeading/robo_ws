...
PyObject * FloatIm2Col_updateOutput(PyObject *_unused, PyObject *args)
{
  ...
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 11 &&
      ...
      int64_t arg_dilationH = THPUtils_unpackLong(PyTuple_GET_ITEM(args, 5));
      int64_t arg_dilationW = THPUtils_unpackLong(PyTuple_GET_ITEM(args, 6));
      int64_t arg_padH = THPUtils_unpackLong(PyTuple_GET_ITEM(args, 7));
      int64_t arg_padW = THPUtils_unpackLong(PyTuple_GET_ITEM(args, 8));
      int64_t arg_dH = THPUtils_unpackLong(PyTuple_GET_ITEM(args, 9));
      int64_t arg_dW = THPUtils_unpackLong(PyTuple_GET_ITEM(args, 10));
      
      PyThreadState *_save = NULL;
      try {
        Py_UNBLOCK_THREADS;
        THNN_FloatIm2Col_updateOutput(arg_state, arg_input, arg_output, arg_kH, arg_kW, arg_dilationH, arg_dilationW, arg_padH, arg_padW, arg_dH, arg_dW);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "FloatIm2Col_updateOutput", 1, "(int state, torch.FloatTensor input, torch.FloatTensor output, int kH, int kW, int dilationH, int dilationW, int padH, int padW, int dH, int dW)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
PyObject * DoubleIm2Col_updateOutput(PyObject *_unused, PyObject *args)
{
  ...
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 11 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_DoubleIm2Col_updateOutput(arg_state, arg_input, arg_output, arg_kH, arg_kW, arg_dilationH, arg_dilationW, arg_padH, arg_padW, arg_dH, arg_dW);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "DoubleIm2Col_updateOutput", 1, "(int state, torch.DoubleTensor input, torch.DoubleTensor output, int kH, int kW, int dilationH, int dilationW, int padH, int padW, int dH, int dW)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
PyObject * FloatIm2Col_updateGradInput(PyObject *_unused, PyObject *args)
{
  ...
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 13 &&
      ...
      THFloatTensor* arg_gradOutput = THNN_FloatTensor_Unpack(PyTuple_GET_ITEM(args, 1));
      THFloatTensor* arg_gradInput = THNN_FloatTensor_Unpack(PyTuple_GET_ITEM(args, 2));
      int64_t arg_isizeH = THPUtils_unpackLong(PyTuple_GET_ITEM(args, 3));
      int64_t arg_isizeW = THPUtils_unpackLong(PyTuple_GET_ITEM(args, 4));
      int64_t arg_kH = THPUtils_unpackLong(PyTuple_GET_ITEM(args, 5));
      int64_t arg_kW = THPUtils_unpackLong(PyTuple_GET_ITEM(args, 6));
      int64_t arg_dilationH = THPUtils_unpackLong(PyTuple_GET_ITEM(args, 7));
      int64_t arg_dilationW = THPUtils_unpackLong(PyTuple_GET_ITEM(args, 8));
      ...
      int64_t arg_dH = THPUtils_unpackLong(PyTuple_GET_ITEM(args, 11));
      int64_t arg_dW = THPUtils_unpackLong(PyTuple_GET_ITEM(args, 12));
      
      PyThreadState *_save = NULL;
      try {
        Py_UNBLOCK_THREADS;
        THNN_FloatIm2Col_updateGradInput(arg_state, arg_gradOutput, arg_gradInput, arg_isizeH, arg_isizeW, arg_kH, arg_kW, arg_dilationH, arg_dilationW, arg_padH, arg_padW, arg_dH, arg_dW);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "FloatIm2Col_updateGradInput", 1, "(int state, torch.FloatTensor gradOutput, torch.FloatTensor gradInput, int isizeH, int isizeW, int kH, int kW, int dilationH, int dilationW, int padH, int padW, int dH, int dW)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
PyObject * DoubleIm2Col_updateGradInput(PyObject *_unused, PyObject *args)
{
  ...
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 13 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_DoubleIm2Col_updateGradInput(arg_state, arg_gradOutput, arg_gradInput, arg_isizeH, arg_isizeW, arg_kH, arg_kW, arg_dilationH, arg_dilationW, arg_padH, arg_padW, arg_dH, arg_dW);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "DoubleIm2Col_updateGradInput", 1, "(int state, torch.DoubleTensor gradOutput, torch.DoubleTensor gradInput, int isizeH, int isizeW, int kH, int kW, int dilationH, int dilationW, int padH, int padW, int dH, int dW)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
PyObject * FloatCol2Im_updateOutput(PyObject *_unused, PyObject *args)
{
  ...
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 13 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_FloatCol2Im_updateOutput(arg_state, arg_input, arg_output, arg_outputHeight, arg_outputWidth, arg_kH, arg_kW, arg_dilationH, arg_dilationW, arg_padH, arg_padW, arg_dH, arg_dW);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "FloatCol2Im_updateOutput", 1, "(int state, torch.FloatTensor input, torch.FloatTensor output, int outputHeight, int outputWidth, int kH, int kW, int dilationH, int dilationW, int padH, int padW, int dH, int dW)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
PyObject * DoubleCol2Im_updateOutput(PyObject *_unused, PyObject *args)
{
  ...
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 13 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_DoubleCol2Im_updateOutput(arg_state, arg_input, arg_output, arg_outputHeight, arg_outputWidth, arg_kH, arg_kW, arg_dilationH, arg_dilationW, arg_padH, arg_padW, arg_dH, arg_dW);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "DoubleCol2Im_updateOutput", 1, "(int state, torch.DoubleTensor input, torch.DoubleTensor output, int outputHeight, int outputWidth, int kH, int kW, int dilationH, int dilationW, int padH, int padW, int dH, int dW)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
PyObject * FloatCol2Im_updateGradInput(PyObject *_unused, PyObject *args)
{
  ...
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 11 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_FloatCol2Im_updateGradInput(arg_state, arg_gradOutput, arg_gradInput, arg_kH, arg_kW, arg_dilationH, arg_dilationW, arg_padH, arg_padW, arg_dH, arg_dW);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "FloatCol2Im_updateGradInput", 1, "(int state, torch.FloatTensor gradOutput, torch.FloatTensor gradInput, int kH, int kW, int dilationH, int dilationW, int padH, int padW, int dH, int dW)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
PyObject * DoubleCol2Im_updateGradInput(PyObject *_unused, PyObject *args)
{
  ...
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 11 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_DoubleCol2Im_updateGradInput(arg_state, arg_gradOutput, arg_gradInput, arg_kH, arg_kW, arg_dilationH, arg_dilationW, arg_padH, arg_padW, arg_dH, arg_dW);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "DoubleCol2Im_updateGradInput", 1, "(int state, torch.DoubleTensor gradOutput, torch.DoubleTensor gradInput, int kH, int kW, int dilationH, int dilationW, int padH, int padW, int dH, int dW)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
TH_API void THNN_FloatSpatialUpSamplingBicubic_updateOutput(void*, THFloatTensor*, THFloatTensor*, int, int, bool);

PyObject * FloatSpatialUpSamplingBicubic_updateOutput(PyObject *_unused, PyObject *args)
{
  HANDLE_TH_ERRORS
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 6 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_FloatSpatialUpSamplingBicubic_updateOutput(arg_state, arg_input, arg_output, arg_osizeH, arg_osizeW, arg_align_corners);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "FloatSpatialUpSamplingBicubic_updateOutput", 1, "(int state, torch.FloatTensor input, torch.FloatTensor output, int osizeH, int osizeW, bool align_corners)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
TH_API void THNN_DoubleSpatialUpSamplingBicubic_updateOutput(void*, THDoubleTensor*, THDoubleTensor*, int, int, bool);

PyObject * DoubleSpatialUpSamplingBicubic_updateOutput(PyObject *_unused, PyObject *args)
{
  HANDLE_TH_ERRORS
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 6 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_DoubleSpatialUpSamplingBicubic_updateOutput(arg_state, arg_input, arg_output, arg_osizeH, arg_osizeW, arg_align_corners);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "DoubleSpatialUpSamplingBicubic_updateOutput", 1, "(int state, torch.DoubleTensor input, torch.DoubleTensor output, int osizeH, int osizeW, bool align_corners)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
TH_API void THNN_FloatSpatialUpSamplingBicubic_updateGradInput(void*, THFloatTensor*, THFloatTensor*, int, int, int, int, int, int, bool);

PyObject * FloatSpatialUpSamplingBicubic_updateGradInput(PyObject *_unused, PyObject *args)
{
  HANDLE_TH_ERRORS
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 10 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_FloatSpatialUpSamplingBicubic_updateGradInput(arg_state, arg_gradOutput, arg_gradInput, arg_isizeB, arg_isizeC, arg_isizeH, arg_isizeW, arg_osizeH, arg_osizeW, arg_align_corners);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "FloatSpatialUpSamplingBicubic_updateGradInput", 1, "(int state, torch.FloatTensor gradOutput, torch.FloatTensor gradInput, int isizeB, int isizeC, int isizeH, int isizeW, int osizeH, int osizeW, bool align_corners)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
TH_API void THNN_DoubleSpatialUpSamplingBicubic_updateGradInput(void*, THDoubleTensor*, THDoubleTensor*, int, int, int, int, int, int, bool);

PyObject * DoubleSpatialUpSamplingBicubic_updateGradInput(PyObject *_unused, PyObject *args)
{
  HANDLE_TH_ERRORS
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 10 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_DoubleSpatialUpSamplingBicubic_updateGradInput(arg_state, arg_gradOutput, arg_gradInput, arg_isizeB, arg_isizeC, arg_isizeH, arg_isizeW, arg_osizeH, arg_osizeW, arg_align_corners);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "DoubleSpatialUpSamplingBicubic_updateGradInput", 1, "(int state, torch.DoubleTensor gradOutput, torch.DoubleTensor gradInput, int isizeB, int isizeC, int isizeH, int isizeW, int osizeH, int osizeW, bool align_corners)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
static PyMethodDef module_methods[] = {
  ...
  {"FloatSpatialUpSamplingBicubic_updateOutput", (PyCFunction)FloatSpatialUpSamplingBicubic_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialUpSamplingBicubic_updateOutput", (PyCFunction)DoubleSpatialUpSamplingBicubic_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSpatialUpSamplingBicubic_updateGradInput", (PyCFunction)FloatSpatialUpSamplingBicubic_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialUpSamplingBicubic_updateGradInput", (PyCFunction)DoubleSpatialUpSamplingBicubic_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
