...
Tensor VariableType::_adaptive_avg_pool2d_backward(const Tensor & grad_output, const Tensor & self) const {
  ...
  auto tmp = ([&]() {
    ...
    return baseType->_adaptive_avg_pool2d_backward(grad_output_, self_);
  })();
...
void VariableType::_cufft_clear_plan_cache(int64_t device_index) const {
...
int64_t VariableType::_cufft_get_plan_cache_max_size(int64_t device_index) const {
...
int64_t VariableType::_debug_has_internal_overlap(const Tensor & self) const {
...
Tensor VariableType::_empty_affine_quantized(IntArrayRef size, const TensorOptions & options, double scale, int64_t zero_point) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_empty_affine_quantized(size, options_, scale, zero_point);
  })();
  auto result = as_variable(tmp);
  if (tracer_state) {
    jit::tracer::setTracingState(std::move(tracer_state));
...
Tensor VariableType::_fft_with_size(const Tensor & self, int64_t signal_ndim, bool complex_input, bool complex_output, bool inverse, IntArrayRef checked_signal_sizes, bool normalized, bool onesided, IntArrayRef output_sizes) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_fft_with_size(self_, signal_ndim, complex_input, complex_output, inverse, checked_signal_sizes, normalized, onesided, output_sizes);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::_log_softmax(const Tensor & self, int64_t dim, bool half_to_float) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_log_softmax(self_, dim, half_to_float);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
std::tuple<Tensor,Tensor,Tensor> VariableType::_lu_with_info(const Tensor & self, bool pivot, bool check_errors) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_lu_with_info(self_, pivot, check_errors);
  })();
...
Tensor VariableType::_multinomial_alias_draw(const Tensor & J, const Tensor & q, int64_t num_samples, Generator * generator) const {
  ...
  auto result = TypeDefault::_multinomial_alias_draw(J, q, num_samples, generator);
  if (tracer_state) {
    jit::tracer::setTracingState(std::move(tracer_state));
    jit::tracer::addOutput(node, result);
  }
...
std::tuple<Tensor,Tensor,Tensor> VariableType::_nnpack_spatial_convolution_backward(const Tensor & input, const Tensor & grad_output, const Tensor & weight, IntArrayRef padding, std::array<bool,3> output_mask) const {
...
Tensor VariableType::_nnpack_spatial_convolution_backward_input(const Tensor & input, const Tensor & grad_output, const Tensor & weight, IntArrayRef padding) const {
...
std::tuple<Tensor,Tensor> VariableType::_pack_padded_sequence(const Tensor & input, const Tensor & lengths, bool batch_first) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_pack_padded_sequence(input_, lengths_, batch_first);
  })();
...
Tensor & VariableType::_sobol_engine_ff_(Tensor & self, int64_t n, const Tensor & sobolstate, int64_t dimension, int64_t num_generated) const {
...
Tensor & VariableType::_sobol_engine_initialize_state_(Tensor & self, int64_t dimension) const {
...
Tensor & VariableType::_sparse_dense_add_out(Tensor & out, const Tensor & self, SparseTensorRef other, Scalar alpha) const {
  RECORD_FUNCTION("_sparse_dense_add_out", std::vector<c10::IValue>({out, self, alpha}), Function::peek_at_next_sequence_nr());
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->_sparse_dense_add_out(out_, self_, other_, alpha);
  }
  #ifndef NDEBUG
...
Tensor & VariableType::_sparse_mul_out(Tensor & out, const Tensor & self, const Tensor & other) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->_sparse_mul_out(out_, self_, other_);
  }
  #ifndef NDEBUG
  if (out__storage_saved.has_value())
    AT_ASSERT(out__storage_saved.value().is_alias_of(out_.storage()));
...
Tensor & VariableType::_sparse_mul_scalar_out(Tensor & out, const Tensor & self, Scalar other) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->_sparse_mul_scalar_out(out_, self_, other);
  }
  #ifndef NDEBUG
  if (out__storage_saved.has_value())
    AT_ASSERT(out__storage_saved.value().is_alias_of(out_.storage()));
...
Tensor VariableType::_th_acos(const Tensor & self) const {
  RECORD_FUNCTION("_th_acos", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_acos(self_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::s__th_addbmm_out(Tensor & result, const Tensor & self, const Tensor & batch1, const Tensor & batch2, Scalar beta, Scalar alpha) const {
  RECORD_FUNCTION("_th_addbmm_out", std::vector<c10::IValue>({result, self, batch1, batch2, beta, alpha}), Function::peek_at_next_sequence_nr());
...
Tensor VariableType::_th_alias(const Tensor & self) const {
  RECORD_FUNCTION("_th_alias", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_alias(self_);
  })();
...
Tensor VariableType::_th_and(const Tensor & self, Scalar other) const {
  RECORD_FUNCTION("_th_and", std::vector<c10::IValue>({self, other}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_and(self_, other);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::s__th_and(const Tensor & self, const Tensor & other) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->s__th_and(self_, other_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::_th_asin(const Tensor & self) const {
  RECORD_FUNCTION("_th_asin", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_asin(self_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::_th_cat(TensorList tensors, int64_t dim) const {
  RECORD_FUNCTION("_th_cat", std::vector<c10::IValue>({}), Function::peek_at_next_sequence_nr());
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_cat(tensors_, dim);
  })();
  auto self = as_variable(tmp);
  #ifndef NDEBUG
  for (size_t i=0; i<tensors_.size(); i++) {
...
Tensor & VariableType::_th_cauchy_(Tensor & self, double median, double sigma, Generator * generator) const {
  RECORD_FUNCTION("_th_cauchy_", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  check_inplace(self);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor & VariableType::_th_ceil_out(Tensor & result, const Tensor & self) const {
  RECORD_FUNCTION("_th_ceil_out", std::vector<c10::IValue>({result, self}), Function::peek_at_next_sequence_nr());
  auto& result_ = unpack(result, "result", 0);
  auto& self_ = unpack(self, "self", 1);
  std::shared_ptr<Function> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor VariableType::_th_cumprod(const Tensor & self, int64_t dim) const {
  RECORD_FUNCTION("_th_cumprod", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_cumprod(self_, dim);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::_th_dot(const Tensor & self, const Tensor & tensor) const {
  RECORD_FUNCTION("_th_dot", std::vector<c10::IValue>({self, tensor}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_dot(self_, tensor_);
  })();
  auto out = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::_th_erf(const Tensor & self) const {
  RECORD_FUNCTION("_th_erf", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor & VariableType::_th_exp_out(Tensor & result, const Tensor & self) const {
  RECORD_FUNCTION("_th_exp_out", std::vector<c10::IValue>({result, self}), Function::peek_at_next_sequence_nr());
  auto& result_ = unpack(result, "result", 0);
  auto& self_ = unpack(self, "self", 1);
  std::shared_ptr<Function> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor VariableType::_th_fmod(const Tensor & self, Scalar other) const {
  RECORD_FUNCTION("_th_fmod", std::vector<c10::IValue>({self, other}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_fmod(self_, other);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::s__th_fmod(const Tensor & self, const Tensor & other) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->s__th_fmod(self_, other_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::_th_fmod_(Tensor & self, Scalar other) const {
  RECORD_FUNCTION("_th_fmod_", std::vector<c10::IValue>({self, other}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  check_inplace(self);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor VariableType::_th_frac(const Tensor & self) const {
  RECORD_FUNCTION("_th_frac", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_frac(self_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::_th_frac_(Tensor & self) const {
  RECORD_FUNCTION("_th_frac_", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  check_inplace(self);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
...
std::tuple<Tensor,Tensor> VariableType::_th_gels(const Tensor & self, const Tensor & A) const {
  RECORD_FUNCTION("_th_gels", std::vector<c10::IValue>({self, A}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_gels(self_, A_);
  })();
...
std::tuple<Tensor &,Tensor &> VariableType::_th_geqrf_out(Tensor & res1, Tensor & res2, const Tensor & self) const {
  RECORD_FUNCTION("_th_geqrf_out", std::vector<c10::IValue>({res1, res2, self}), Function::peek_at_next_sequence_nr());
...
Tensor & VariableType::_th_ger_out(Tensor & result, const Tensor & self, const Tensor & vec2) const {
  RECORD_FUNCTION("_th_ger_out", std::vector<c10::IValue>({result, self, vec2}), Function::peek_at_next_sequence_nr());
  auto& result_ = unpack(result, "result", 0);
  auto& self_ = unpack(self, "self", 1);
...
Tensor & VariableType::_th_iand_(Tensor & self, Scalar other) const {
  RECORD_FUNCTION("_th_iand_", std::vector<c10::IValue>({self, other}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  check_inplace(self);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor & VariableType::_th_lgamma_out(Tensor & result, const Tensor & self) const {
  RECORD_FUNCTION("_th_lgamma_out", std::vector<c10::IValue>({result, self}), Function::peek_at_next_sequence_nr());
  auto& result_ = unpack(result, "result", 0);
  auto& self_ = unpack(self, "self", 1);
  std::shared_ptr<Function> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor VariableType::_th_log(const Tensor & self) const {
  RECORD_FUNCTION("_th_log", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor & VariableType::_th_log1p_out(Tensor & result, const Tensor & self) const {
  RECORD_FUNCTION("_th_log1p_out", std::vector<c10::IValue>({result, self}), Function::peek_at_next_sequence_nr());
  auto& result_ = unpack(result, "result", 0);
  auto& self_ = unpack(self, "self", 1);
  std::shared_ptr<Function> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor VariableType::_th_log2(const Tensor & self) const {
  RECORD_FUNCTION("_th_log2", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_log2(self_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::s__th_masked_fill_(Tensor & self, const Tensor & mask, Scalar value) const {
  RECORD_FUNCTION("_th_masked_fill_", std::vector<c10::IValue>({self, mask, value}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
...
Tensor & VariableType::s__th_masked_scatter_(Tensor & self, const Tensor & mask, const Tensor & source) const {
  RECORD_FUNCTION("_th_masked_scatter_", std::vector<c10::IValue>({self, mask, source}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  auto& mask_ = unpack(mask, "mask", 1);
...
Tensor & VariableType::_th_mm_out(Tensor & result, const Tensor & self, const Tensor & mat2) const {
  RECORD_FUNCTION("_th_mm_out", std::vector<c10::IValue>({result, self, mat2}), Function::peek_at_next_sequence_nr());
  auto& result_ = unpack(result, "result", 0);
  auto& self_ = unpack(self, "self", 1);
...
Tensor VariableType::_th_multinomial_alias_draw(const Tensor & q, const Tensor & J, int64_t num_samples, Generator * generator) const {
  RECORD_FUNCTION("_th_multinomial_alias_draw", std::vector<c10::IValue>({q, J}), Function::peek_at_next_sequence_nr());
  auto& q_ = unpack(q, "q", 0);
  auto& J_ = unpack(J, "J", 1);
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
    tracer_state = jit::tracer::getTracingState();
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_multinomial_alias_draw(q_, J_, num_samples, generator);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
...
std::tuple<Tensor &,Tensor &> VariableType::_th_multinomial_alias_setup_out(Tensor & J, Tensor & q, const Tensor & probs) const {
  RECORD_FUNCTION("_th_multinomial_alias_setup_out", std::vector<c10::IValue>({J, q, probs}), Function::peek_at_next_sequence_nr());
  auto& J_ = unpack(J, "J", 0);
  auto& q_ = unpack(q, "q", 1);
  auto& probs_ = unpack(probs, "probs", 2);
  std::shared_ptr<Function> grad_fn;
  if (compute_requires_grad( probs )) {
    throw_error_out_requires_grad("_th_multinomial_alias_setup");
  }
  if (compute_requires_grad( q )) {
    throw_error_out_requires_grad("_th_multinomial_alias_setup");
  }
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
    tracer_state = jit::tracer::getTracingState();
    at::Symbol op_name;
    op_name = jit::Symbol::fromQualString("aten::_th_multinomial_alias_setup");
    node = tracer_state->graph->create(op_name, /*num_outputs=*/0);
    jit::tracer::recordSourceLocation(node);
    jit::tracer::addInputs(node, "q", q);
    ...
    tracer_state->graph->insertNode(node);
    jit::tracer::ensureUniqueIfOutOfPlaced("_th_multinomial_alias_setup_out", J);
    jit::tracer::setTracingState(nullptr);
  }
  #ifndef NDEBUG
  c10::optional<Storage> J__storage_saved =
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->_th_multinomial_alias_setup_out(J_, q_, probs_);
  }
  #ifndef NDEBUG
  if (J__storage_saved.has_value())
    AT_ASSERT(J__storage_saved.value().is_alias_of(J_.storage()));
  ...
  increment_version(q);
  if (grad_fn) {
      rebase_history(flatten_tensor_args( q ), grad_fn);
  }
  if (tracer_state) {
    jit::tracer::setTracingState(std::move(tracer_state));
    jit::tracer::addOutput(node, J);
    jit::tracer::addOutput(node, q);
  }
  return std::forward_as_tuple(J, q);
}
Tensor VariableType::_th_mv(const Tensor & self, const Tensor & vec) const {
  RECORD_FUNCTION("_th_mv", std::vector<c10::IValue>({self, vec}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_mv(self_, vec_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::_th_polygamma(int64_t n, const Tensor & self) const {
  RECORD_FUNCTION("_th_polygamma", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 1);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_polygamma(n, self_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::_th_polygamma_(Tensor & self, int64_t n) const {
  RECORD_FUNCTION("_th_polygamma_", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  check_inplace(self);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor & VariableType::_th_potri_out(Tensor & output, const Tensor & self, bool upper) const {
  RECORD_FUNCTION("_th_potri_out", std::vector<c10::IValue>({output, self}), Function::peek_at_next_sequence_nr());
...
Tensor VariableType::_th_pow(const Tensor & self, Scalar exponent) const {
  RECORD_FUNCTION("_th_pow", std::vector<c10::IValue>({self, exponent}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_pow(self_, exponent);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::s__th_pow(const Tensor & self, const Tensor & exponent) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->s__th_pow(self_, exponent_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::_th_pow(Scalar self, const Tensor & exponent) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_pow(self, exponent_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (exponent__storage_saved.has_value())
...
Tensor & VariableType::_th_pow_(Tensor & self, Scalar exponent) const {
  RECORD_FUNCTION("_th_pow_", std::vector<c10::IValue>({self, exponent}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  check_inplace(self);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
...
std::tuple<Tensor,Tensor> VariableType::_th_qr(const Tensor & self) const {
  RECORD_FUNCTION("_th_qr", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor VariableType::_th_round(const Tensor & self) const {
  RECORD_FUNCTION("_th_round", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_round(self_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::_th_rsqrt(const Tensor & self) const {
  RECORD_FUNCTION("_th_rsqrt", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_rsqrt(self_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::_th_set_(Tensor & self, Storage source) const {
  RECORD_FUNCTION("_th_set_", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  check_inplace(self);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor & VariableType::_th_set_(Tensor & self, Storage source, int64_t storage_offset, IntArrayRef size, IntArrayRef stride) const {
  RECORD_FUNCTION("_th_set_", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  check_inplace(self);
  std::shared_ptr<NotImplemented> grad_fn;
...
Tensor & VariableType::_th_set_(Tensor & self, const Tensor & source) const {
  RECORD_FUNCTION("_th_set_", std::vector<c10::IValue>({self, source}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
...
Tensor & VariableType::_th_sigmoid_out(Tensor & result, const Tensor & self) const {
  RECORD_FUNCTION("_th_sigmoid_out", std::vector<c10::IValue>({result, self}), Function::peek_at_next_sequence_nr());
  auto& result_ = unpack(result, "result", 0);
  auto& self_ = unpack(self, "self", 1);
  std::shared_ptr<Function> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor & VariableType::_th_sign_out(Tensor & result, const Tensor & self) const {
  RECORD_FUNCTION("_th_sign_out", std::vector<c10::IValue>({result, self}), Function::peek_at_next_sequence_nr());
  auto& result_ = unpack(result, "result", 0);
  auto& self_ = unpack(self, "self", 1);
  std::shared_ptr<Function> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor & VariableType::_th_sqrt_out(Tensor & result, const Tensor & self) const {
  RECORD_FUNCTION("_th_sqrt_out", std::vector<c10::IValue>({result, self}), Function::peek_at_next_sequence_nr());
  auto& result_ = unpack(result, "result", 0);
  auto& self_ = unpack(self, "self", 1);
  std::shared_ptr<Function> grad_fn;
  if (compute_requires_grad( self )) {
...
std::tuple<Tensor &,Tensor &,Tensor &> VariableType::_th_svd_out(Tensor & res1, Tensor & res2, Tensor & res3, const Tensor & self, bool some, bool compute_uv) const {
  RECORD_FUNCTION("_th_svd_out", std::vector<c10::IValue>({res1, res2, res3, self}), Function::peek_at_next_sequence_nr());
  auto& res1_ = unpack(res1, "res1", 0);
  auto& res2_ = unpack(res2, "res2", 1);
  ...
  c10::intrusive_ptr<TensorImpl> res2__impl_saved;
  if (res2_.defined()) res2__impl_saved = res2_.getIntrusivePtr();
  c10::optional<Storage> res3__storage_saved =
    res3_.has_storage() ? c10::optional<Storage>(res3_.storage()) : c10::nullopt;
  c10::intrusive_ptr<TensorImpl> res3__impl_saved;
  if (res3_.defined()) res3__impl_saved = res3_.getIntrusivePtr();
  c10::optional<Storage> self__storage_saved =
    self_.has_storage() ? c10::optional<Storage>(self_.storage()) : c10::nullopt;
  c10::intrusive_ptr<TensorImpl> self__impl_saved;
  if (self_.defined()) self__impl_saved = self_.getIntrusivePtr();
  ...
  if (res2__storage_saved.has_value())
    AT_ASSERT(res2__storage_saved.value().is_alias_of(res2_.storage()));
  if (res2__impl_saved) AT_ASSERT(res2__impl_saved == res2_.getIntrusivePtr());
  if (res3__storage_saved.has_value())
    AT_ASSERT(res3__storage_saved.value().is_alias_of(res3_.storage()));
  if (res3__impl_saved) AT_ASSERT(res3__impl_saved == res3_.getIntrusivePtr());
  if (self__storage_saved.has_value())
    AT_ASSERT(self__storage_saved.value().is_alias_of(self_.storage()));
  if (self__impl_saved) AT_ASSERT(self__impl_saved == self_.getIntrusivePtr());
  #endif
...
Tensor & VariableType::_th_tan_out(Tensor & result, const Tensor & self) const {
  RECORD_FUNCTION("_th_tan_out", std::vector<c10::IValue>({result, self}), Function::peek_at_next_sequence_nr());
  auto& result_ = unpack(result, "result", 0);
  auto& self_ = unpack(self, "self", 1);
  std::shared_ptr<Function> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor VariableType::_th_tanh(const Tensor & self) const {
  RECORD_FUNCTION("_th_tanh", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_tanh(self_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::_th_trace(const Tensor & self) const {
  RECORD_FUNCTION("_th_trace", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_trace(self_);
  })();
  auto out = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::_th_unfold_out(Tensor & result, const Tensor & self, int64_t dimension, int64_t size, int64_t step) const {
  RECORD_FUNCTION("_th_unfold_out", std::vector<c10::IValue>({result, self}), Function::peek_at_next_sequence_nr());
  auto& result_ = unpack(result, "result", 0);
  auto& self_ = unpack(self, "self", 1);
  std::shared_ptr<Function> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor & VariableType::_thnn_adaptive_avg_pool3d_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self) const {
  RECORD_FUNCTION("_thnn_adaptive_avg_pool3d_backward_out", std::vector<c10::IValue>({grad_input, grad_output, self}), Function::peek_at_next_sequence_nr());
...
Tensor VariableType::_thnn_avg_pool2d_forward(const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, bool ceil_mode, bool count_include_pad) const {
  RECORD_FUNCTION("_thnn_avg_pool2d_forward", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_avg_pool2d_forward(self_, kernel_size, stride, padding, ceil_mode, count_include_pad);
  })();
...
Tensor VariableType::_thnn_avg_pool3d_backward(const Tensor & grad_output, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, bool ceil_mode, bool count_include_pad) const {
  RECORD_FUNCTION("_thnn_avg_pool3d_backward", std::vector<c10::IValue>({grad_output, self}), Function::peek_at_next_sequence_nr());
  auto& grad_output_ = unpack(grad_output, "grad_output", 0);
  auto& self_ = unpack(self, "self", 1);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( grad_output, self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_avg_pool3d_backward(grad_output_, self_, kernel_size, stride, padding, ceil_mode, count_include_pad);
  })();
...
Tensor & VariableType::_thnn_avg_pool3d_forward_out(Tensor & output, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, bool ceil_mode, bool count_include_pad) const {
  RECORD_FUNCTION("_thnn_avg_pool3d_forward_out", std::vector<c10::IValue>({output, self}), Function::peek_at_next_sequence_nr());
  auto& output_ = unpack(output, "output", 0);
  auto& self_ = unpack(self, "self", 1);
  std::shared_ptr<Function> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor & VariableType::_thnn_col2im_backward_out(Tensor & grad_input, const Tensor & grad_output, IntArrayRef kernel_size, IntArrayRef dilation, IntArrayRef padding, IntArrayRef stride) const {
  RECORD_FUNCTION("_thnn_col2im_backward_out", std::vector<c10::IValue>({grad_input, grad_output}), Function::peek_at_next_sequence_nr());
  auto& grad_input_ = unpack(grad_input, "grad_input", 0);
  auto& grad_output_ = unpack(grad_output, "grad_output", 1);
  std::shared_ptr<Function> grad_fn;
...
std::tuple<Tensor,Tensor> VariableType::_thnn_conv_depthwise2d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, std::array<bool,2> output_mask) const {
  RECORD_FUNCTION("_thnn_conv_depthwise2d_backward", std::vector<c10::IValue>({grad_output, self, weight}), Function::peek_at_next_sequence_nr());
  auto& grad_output_ = unpack(grad_output, "grad_output", 0);
  auto& self_ = unpack(self, "self", 1);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_conv_depthwise2d_backward(grad_output_, self_, weight_, kernel_size, stride, padding, dilation, output_mask);
  })();
...
Tensor & VariableType::_thnn_conv_depthwise2d_forward_out(Tensor & output, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, const Tensor & bias, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation) const {
  RECORD_FUNCTION("_thnn_conv_depthwise2d_forward_out", std::vector<c10::IValue>({output, self, weight, bias}), Function::peek_at_next_sequence_nr());
  auto& output_ = unpack(output, "output", 0);
  auto& self_ = unpack(self, "self", 1);
  auto& weight_ = unpack(weight, "weight", 2);
...
std::tuple<Tensor,Tensor,Tensor> VariableType::_thnn_conv_dilated2d_forward(const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, const Tensor & bias, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation) const {
  RECORD_FUNCTION("_thnn_conv_dilated2d_forward", std::vector<c10::IValue>({self, weight, bias}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_conv_dilated2d_forward(self_, weight_, kernel_size, bias_, stride, padding, dilation);
  })();
...
std::tuple<Tensor,Tensor,Tensor> VariableType::_thnn_conv_dilated3d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, const Tensor & columns, const Tensor & ones, std::array<bool,3> output_mask) const {
  RECORD_FUNCTION("_thnn_conv_dilated3d_backward", std::vector<c10::IValue>({grad_output, self, weight, columns, ones}), Function::peek_at_next_sequence_nr());
  auto& grad_output_ = unpack(grad_output, "grad_output", 0);
  auto& self_ = unpack(self, "self", 1);
  auto& weight_ = unpack(weight, "weight", 2);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_conv_dilated3d_backward(grad_output_, self_, weight_, kernel_size, stride, padding, dilation, columns_, ones_, output_mask);
  })();
...
std::tuple<Tensor &,Tensor &,Tensor &> VariableType::_thnn_conv_dilated3d_forward_out(Tensor & output, Tensor & columns, Tensor & ones, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, const Tensor & bias, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation) const {
  RECORD_FUNCTION("_thnn_conv_dilated3d_forward_out", std::vector<c10::IValue>({output, columns, ones, self, weight, bias}), Function::peek_at_next_sequence_nr());
  auto& output_ = unpack(output, "output", 0);
...
std::tuple<Tensor,Tensor,Tensor> VariableType::_thnn_conv_transpose3d_forward(const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, const Tensor & bias, IntArrayRef stride, IntArrayRef padding, IntArrayRef output_padding, IntArrayRef dilation) const {
  RECORD_FUNCTION("_thnn_conv_transpose3d_forward", std::vector<c10::IValue>({self, weight, bias}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  auto& weight_ = unpack(weight, "weight", 1);
  auto bias_ = unpack_opt(bias, "bias", 3);
  std::shared_ptr<NotImplemented> grad_fn;
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_conv_transpose3d_forward(self_, weight_, kernel_size, bias_, stride, padding, output_padding, dilation);
  })();
...
Tensor VariableType::_thnn_elu_backward(const Tensor & grad_output, Scalar alpha, Scalar scale, Scalar input_scale, const Tensor & output) const {
  RECORD_FUNCTION("_thnn_elu_backward", std::vector<c10::IValue>({grad_output, alpha, scale, input_scale, output}), Function::peek_at_next_sequence_nr());
  auto& grad_output_ = unpack(grad_output, "grad_output", 0);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_elu_backward(grad_output_, alpha, scale, input_scale, output_);
  })();
  auto grad_input = as_variable(tmp);
  #ifndef NDEBUG
  if (grad_output__storage_saved.has_value())
...
Tensor & VariableType::_thnn_elu_forward_out(Tensor & output, const Tensor & self, Scalar alpha, Scalar scale, Scalar input_scale) const {
  RECORD_FUNCTION("_thnn_elu_forward_out", std::vector<c10::IValue>({output, self, alpha, scale, input_scale}), Function::peek_at_next_sequence_nr());
  auto& output_ = unpack(output, "output", 0);
  auto& self_ = unpack(self, "self", 1);
  std::shared_ptr<Function> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor & VariableType::_thnn_hardtanh_(Tensor & self, Scalar min_val, Scalar max_val) const {
  RECORD_FUNCTION("_thnn_hardtanh_", std::vector<c10::IValue>({self, min_val, max_val}), Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
    tracer_state = jit::tracer::getTracingState();
...
Tensor & VariableType::_thnn_hardtanh_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, Scalar min_val, Scalar max_val) const {
  RECORD_FUNCTION("_thnn_hardtanh_backward_out", std::vector<c10::IValue>({grad_input, grad_output, self, min_val, max_val}), Function::peek_at_next_sequence_nr());
  auto& grad_input_ = unpack(grad_input, "grad_input", 0);
  auto& grad_output_ = unpack(grad_output, "grad_output", 1);
  auto& self_ = unpack(self, "self", 2);
  std::shared_ptr<Function> grad_fn;
...
Tensor & VariableType::_thnn_im2col_backward_out(Tensor & grad_input, const Tensor & grad_output, IntArrayRef input_size, IntArrayRef kernel_size, IntArrayRef dilation, IntArrayRef padding, IntArrayRef stride) const {
  RECORD_FUNCTION("_thnn_im2col_backward_out", std::vector<c10::IValue>({grad_input, grad_output}), Function::peek_at_next_sequence_nr());
  auto& grad_input_ = unpack(grad_input, "grad_input", 0);
  auto& grad_output_ = unpack(grad_output, "grad_output", 1);
  std::shared_ptr<Function> grad_fn;
  if (compute_requires_grad( grad_output )) {
...
Tensor VariableType::_thnn_l1_loss_backward(const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction) const {
  RECORD_FUNCTION("_thnn_l1_loss_backward", std::vector<c10::IValue>({grad_output, self, target}), Function::peek_at_next_sequence_nr());
  auto& grad_output_ = unpack(grad_output, "grad_output", 0);
  auto& self_ = unpack(self, "self", 1);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_l1_loss_backward(grad_output_, self_, target_, reduction);
  })();
  auto grad_input = as_variable(tmp);
  #ifndef NDEBUG
  if (grad_output__storage_saved.has_value())
...
Tensor & VariableType::_thnn_l1_loss_forward_out(Tensor & output, const Tensor & self, const Tensor & target, int64_t reduction) const {
  RECORD_FUNCTION("_thnn_l1_loss_forward_out", std::vector<c10::IValue>({output, self, target}), Function::peek_at_next_sequence_nr());
  auto& output_ = unpack(output, "output", 0);
  auto& self_ = unpack(self, "self", 1);
  auto& target_ = unpack(target, "target", 2);
  std::shared_ptr<Function> grad_fn;
...
std::tuple<Tensor,Tensor> VariableType::_thnn_log_sigmoid_forward(const Tensor & self) const {
  RECORD_FUNCTION("_thnn_log_sigmoid_forward", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_log_sigmoid_forward(self_);
  })();
...
Tensor & VariableType::_thnn_max_pool2d_with_indices_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, bool ceil_mode, const Tensor & indices) const {
  RECORD_FUNCTION("_thnn_max_pool2d_with_indices_backward_out", std::vector<c10::IValue>({grad_input, grad_output, self, indices}), Function::peek_at_next_sequence_nr());
  auto& grad_input_ = unpack(grad_input, "grad_input", 0);
  auto& grad_output_ = unpack(grad_output, "grad_output", 1);
  auto& self_ = unpack(self, "self", 2);
...
Tensor VariableType::_thnn_max_unpool2d_forward(const Tensor & self, const Tensor & indices, IntArrayRef output_size) const {
  RECORD_FUNCTION("_thnn_max_unpool2d_forward", std::vector<c10::IValue>({self, indices}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_max_unpool2d_forward(self_, indices_, output_size);
  })();
  auto output = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::_thnn_max_unpool3d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & indices, IntArrayRef output_size, IntArrayRef stride, IntArrayRef padding) const {
  RECORD_FUNCTION("_thnn_max_unpool3d_backward", std::vector<c10::IValue>({grad_output, self, indices}), Function::peek_at_next_sequence_nr());
  auto& grad_output_ = unpack(grad_output, "grad_output", 0);
  auto& self_ = unpack(self, "self", 1);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_max_unpool3d_backward(grad_output_, self_, indices_, output_size, stride, padding);
  })();
  auto grad_input = as_variable(tmp);
  #ifndef NDEBUG
  if (grad_output__storage_saved.has_value())
...
Tensor & VariableType::_thnn_max_unpool3d_forward_out(Tensor & output, const Tensor & self, const Tensor & indices, IntArrayRef output_size, IntArrayRef stride, IntArrayRef padding) const {
  RECORD_FUNCTION("_thnn_max_unpool3d_forward_out", std::vector<c10::IValue>({output, self, indices}), Function::peek_at_next_sequence_nr());
  auto& output_ = unpack(output, "output", 0);
  auto& self_ = unpack(self, "self", 1);
  auto& indices_ = unpack(indices, "indices", 2);
  std::shared_ptr<Function> grad_fn;
...
Tensor & VariableType::_thnn_multi_margin_loss_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & target, Scalar p, Scalar margin, const Tensor & weight, int64_t reduction) const {
  RECORD_FUNCTION("_thnn_multi_margin_loss_backward_out", std::vector<c10::IValue>({grad_input, grad_output, self, target, p, margin, weight}), Function::peek_at_next_sequence_nr());
  auto& grad_input_ = unpack(grad_input, "grad_input", 0);
  auto& grad_output_ = unpack(grad_output, "grad_output", 1);
  auto& self_ = unpack(self, "self", 2);
...
std::tuple<Tensor,Tensor> VariableType::_thnn_nll_loss2d_forward(const Tensor & self, const Tensor & target, const Tensor & weight, int64_t reduction, int64_t ignore_index) const {
  RECORD_FUNCTION("_thnn_nll_loss2d_forward", std::vector<c10::IValue>({self, target, weight}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_nll_loss2d_forward(self_, target_, weight_, reduction, ignore_index);
  })();
...
std::tuple<Tensor,Tensor> VariableType::_thnn_nll_loss_forward(const Tensor & self, const Tensor & target, const Tensor & weight, int64_t reduction, int64_t ignore_index) const {
  RECORD_FUNCTION("_thnn_nll_loss_forward", std::vector<c10::IValue>({self, target, weight}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  auto& target_ = unpack(target, "target", 1);
  auto weight_ = unpack_opt(weight, "weight", 2);
  std::shared_ptr<NotImplemented> grad_fn;
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_nll_loss_forward(self_, target_, weight_, reduction, ignore_index);
  })();
  std::tie(output, total_weight) = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::_thnn_rrelu_with_noise_forward(const Tensor & self, const Tensor & noise, Scalar lower, Scalar upper, bool training, Generator * generator) const {
  RECORD_FUNCTION("_thnn_rrelu_with_noise_forward", std::vector<c10::IValue>({self, noise, lower, upper}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_rrelu_with_noise_forward(self_, noise_, lower, upper, training, generator);
  })();
  auto output = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::_thnn_rrelu_with_noise_forward_(Tensor & self, const Tensor & noise, Scalar lower, Scalar upper, bool training, Generator * generator) const {
  RECORD_FUNCTION("_thnn_rrelu_with_noise_forward_", std::vector<c10::IValue>({self, noise, lower, upper}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  auto& noise_ = unpack(noise, "noise", 1);
  check_inplace(self);
  std::shared_ptr<NotImplemented> grad_fn;
...
Tensor & VariableType::_thnn_smooth_l1_loss_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction) const {
  RECORD_FUNCTION("_thnn_smooth_l1_loss_backward_out", std::vector<c10::IValue>({grad_input, grad_output, self, target}), Function::peek_at_next_sequence_nr());
  auto& grad_input_ = unpack(grad_input, "grad_input", 0);
  auto& grad_output_ = unpack(grad_output, "grad_output", 1);
  auto& self_ = unpack(self, "self", 2);
  auto& target_ = unpack(target, "target", 3);
...
Tensor VariableType::_thnn_soft_margin_loss_backward(const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction) const {
  RECORD_FUNCTION("_thnn_soft_margin_loss_backward", std::vector<c10::IValue>({grad_output, self, target}), Function::peek_at_next_sequence_nr());
  auto& grad_output_ = unpack(grad_output, "grad_output", 0);
  auto& self_ = unpack(self, "self", 1);
  auto& target_ = unpack(target, "target", 2);
  std::shared_ptr<NotImplemented> grad_fn;
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_soft_margin_loss_backward(grad_output_, self_, target_, reduction);
  })();
  auto grad_input = as_variable(tmp);
  #ifndef NDEBUG
  if (grad_output__storage_saved.has_value())
...
Tensor & VariableType::_thnn_soft_margin_loss_forward_out(Tensor & output, const Tensor & self, const Tensor & target, int64_t reduction) const {
  RECORD_FUNCTION("_thnn_soft_margin_loss_forward_out", std::vector<c10::IValue>({output, self, target}), Function::peek_at_next_sequence_nr());
  auto& output_ = unpack(output, "output", 0);
  auto& self_ = unpack(self, "self", 1);
  auto& target_ = unpack(target, "target", 2);
  std::shared_ptr<Function> grad_fn;
...
Tensor VariableType::_thnn_softplus_backward(const Tensor & grad_output, const Tensor & self, Scalar beta, Scalar threshold, const Tensor & output) const {
  RECORD_FUNCTION("_thnn_softplus_backward", std::vector<c10::IValue>({grad_output, self, beta, threshold, output}), Function::peek_at_next_sequence_nr());
  auto& grad_output_ = unpack(grad_output, "grad_output", 0);
  auto& self_ = unpack(self, "self", 1);
  auto& output_ = unpack(output, "output", 4);
  std::shared_ptr<NotImplemented> grad_fn;
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_softplus_backward(grad_output_, self_, beta, threshold, output_);
  })();
  auto grad_input = as_variable(tmp);
  #ifndef NDEBUG
  if (grad_output__storage_saved.has_value())
...
Tensor & VariableType::_thnn_softplus_forward_out(Tensor & output, const Tensor & self, Scalar beta, Scalar threshold) const {
  RECORD_FUNCTION("_thnn_softplus_forward_out", std::vector<c10::IValue>({output, self, beta, threshold}), Function::peek_at_next_sequence_nr());
  auto& output_ = unpack(output, "output", 0);
  auto& self_ = unpack(self, "self", 1);
  std::shared_ptr<Function> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor & VariableType::_thnn_tanh_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & output) const {
  RECORD_FUNCTION("_thnn_tanh_backward_out", std::vector<c10::IValue>({grad_input, grad_output, output}), Function::peek_at_next_sequence_nr());
  auto& grad_input_ = unpack(grad_input, "grad_input", 0);
  auto& grad_output_ = unpack(grad_output, "grad_output", 1);
...
Tensor & VariableType::_thnn_upsample_bicubic2d_backward_out(Tensor & grad_input, const Tensor & grad_output, IntArrayRef output_size, IntArrayRef input_size, bool align_corners) const {
  RECORD_FUNCTION("_thnn_upsample_bicubic2d_backward_out", std::vector<c10::IValue>({grad_input, grad_output}), Function::peek_at_next_sequence_nr());
  auto& grad_input_ = unpack(grad_input, "grad_input", 0);
  auto& grad_output_ = unpack(grad_output, "grad_output", 1);
  std::shared_ptr<Function> grad_fn;
  if (compute_requires_grad( grad_output )) {
...
Tensor VariableType::_thnn_upsample_linear1d_forward(const Tensor & self, IntArrayRef output_size, bool align_corners) const {
  RECORD_FUNCTION("_thnn_upsample_linear1d_forward", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_upsample_linear1d_forward(self_, output_size, align_corners);
  })();
  auto output = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::_thnn_upsample_nearest2d_forward(const Tensor & self, IntArrayRef output_size) const {
  RECORD_FUNCTION("_thnn_upsample_nearest2d_forward", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_upsample_nearest2d_forward(self_, output_size);
  })();
  auto output = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::_thnn_upsample_nearest3d_backward(const Tensor & grad_output, IntArrayRef output_size, IntArrayRef input_size) const {
  RECORD_FUNCTION("_thnn_upsample_nearest3d_backward", std::vector<c10::IValue>({grad_output}), Function::peek_at_next_sequence_nr());
  auto& grad_output_ = unpack(grad_output, "grad_output", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( grad_output )) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_upsample_nearest3d_backward(grad_output_, output_size, input_size);
  })();
  auto grad_input = as_variable(tmp);
  #ifndef NDEBUG
  if (grad_output__storage_saved.has_value())
...
Tensor & VariableType::_thnn_upsample_nearest3d_forward_out(Tensor & output, const Tensor & self, IntArrayRef output_size) const {
  RECORD_FUNCTION("_thnn_upsample_nearest3d_forward_out", std::vector<c10::IValue>({output, self}), Function::peek_at_next_sequence_nr());
  auto& output_ = unpack(output, "output", 0);
  auto& self_ = unpack(self, "self", 1);
  std::shared_ptr<Function> grad_fn;
  if (compute_requires_grad( self )) {
...
Tensor & VariableType::_thnn_upsample_trilinear3d_backward_out(Tensor & grad_input, const Tensor & grad_output, IntArrayRef output_size, IntArrayRef input_size, bool align_corners) const {
  RECORD_FUNCTION("_thnn_upsample_trilinear3d_backward_out", std::vector<c10::IValue>({grad_input, grad_output}), Function::peek_at_next_sequence_nr());
  auto& grad_input_ = unpack(grad_input, "grad_input", 0);
  auto& grad_output_ = unpack(grad_output, "grad_output", 1);
  std::shared_ptr<Function> grad_fn;
  if (compute_requires_grad( grad_output )) {
...
Tensor VariableType::adaptive_avg_pool3d(const Tensor & self, IntArrayRef output_size) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->adaptive_avg_pool3d(self_, output_size);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::add(const Tensor & self, Scalar other, Scalar alpha) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->add(self_, other, alpha);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::addbmm_out(Tensor & out, const Tensor & self, const Tensor & batch1, const Tensor & batch2, Scalar beta, Scalar alpha) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->addbmm_out(out_, self_, batch1_, batch2_, beta, alpha);
  }
  #ifndef NDEBUG
  if (out__storage_saved.has_value())
    AT_ASSERT(out__storage_saved.value().is_alias_of(out_.storage()));
...
Tensor VariableType::affine_grid_generator_backward(const Tensor & grad, IntArrayRef size) const {
...
Tensor & VariableType::all_out(Tensor & out, const Tensor & self, int64_t dim, bool keepdim) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->all_out(out_, self_, dim, keepdim);
  }
  #ifndef NDEBUG
  if (out__storage_saved.has_value())
    AT_ASSERT(out__storage_saved.value().is_alias_of(out_.storage()));
...
Tensor & VariableType::any_out(Tensor & out, const Tensor & self, int64_t dim, bool keepdim) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->any_out(out_, self_, dim, keepdim);
  }
  #ifndef NDEBUG
  if (out__storage_saved.has_value())
    AT_ASSERT(out__storage_saved.value().is_alias_of(out_.storage()));
...
Tensor VariableType::arange(Scalar end, const TensorOptions & options) const {
...
Tensor VariableType::arange(Scalar start, Scalar end, const TensorOptions & options) const {
...
Tensor VariableType::arange(Scalar start, Scalar end, Scalar step, const TensorOptions & options) const {
...
Tensor VariableType::avg_pool3d_backward(const Tensor & grad_output, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, bool ceil_mode, bool count_include_pad) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->avg_pool3d_backward(grad_output_, self_, kernel_size, stride, padding, ceil_mode, count_include_pad);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (grad_output__storage_saved.has_value())
...
std::tuple<Tensor,Tensor> VariableType::batch_norm_gather_stats(const Tensor & input, const Tensor & mean, const Tensor & invstd, const Tensor & running_mean, const Tensor & running_var, double momentum, double eps, int64_t count) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->batch_norm_gather_stats(input_, mean_, invstd_, running_mean_, running_var_, momentum, eps, count);
  })();
  std::tie(result0, result1) = as_variable(tmp);
  #ifndef NDEBUG
  if (input__storage_saved.has_value())
...
std::tuple<Tensor,Tensor> VariableType::batch_norm_stats(const Tensor & input, double eps) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->batch_norm_stats(input_, eps);
  })();
  std::tie(result0, result1) = as_variable(tmp);
  #ifndef NDEBUG
  if (input__storage_saved.has_value())
...
Tensor VariableType::bernoulli(const Tensor & self, Generator * generator) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->bernoulli(self_, generator);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::cat(TensorList tensors, int64_t dim) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->cat(tensors_, dim);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  for (size_t i=0; i<tensors_.size(); i++) {
...
Tensor & VariableType::ceil_out(Tensor & out, const Tensor & self) const {
...
Tensor VariableType::conv1d(const Tensor & input, const Tensor & weight, const Tensor & bias, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, int64_t groups) const {
...
Tensor VariableType::cudnn_affine_grid_generator(const Tensor & theta, int64_t N, int64_t C, int64_t H, int64_t W) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->cudnn_affine_grid_generator(theta_, N, C, H, W);
  })();
...
Tensor VariableType::cudnn_convolution(const Tensor & self, const Tensor & weight, const Tensor & bias, IntArrayRef padding, IntArrayRef stride, IntArrayRef dilation, int64_t groups, bool benchmark, bool deterministic) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->cudnn_convolution(self_, weight_, bias_, padding, stride, dilation, groups, benchmark, deterministic);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::cudnn_convolution_transpose_backward_weight(IntArrayRef weight_size, const Tensor & grad_output, const Tensor & self, IntArrayRef padding, IntArrayRef stride, IntArrayRef dilation, int64_t groups, bool benchmark, bool deterministic) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->cudnn_convolution_transpose_backward_weight(weight_size, grad_output_, self_, padding, stride, dilation, groups, benchmark, deterministic);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (grad_output__storage_saved.has_value())
...
Tensor VariableType::cumprod(const Tensor & self, int64_t dim, ScalarType dtype) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->cumprod(self_, dim, dtype);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::cumprod(const Tensor & self, int64_t dim) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->cumprod(self_, dim);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::dequantize(const Tensor & self) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->dequantize(self_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::div_out(Tensor & out, const Tensor & self, const Tensor & other) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->div_out(out_, self_, other_);
  }
  #ifndef NDEBUG
  if (out__storage_saved.has_value())
    AT_ASSERT(out__storage_saved.value().is_alias_of(out_.storage()));
...
Tensor VariableType::dot(const Tensor & self, const Tensor & tensor) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->dot(self_, tensor_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::embedding(const Tensor & weight, const Tensor & indices, int64_t padding_idx, bool scale_grad_by_freq, bool sparse) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->embedding(weight_, indices_, padding_idx, scale_grad_by_freq, sparse);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (weight__storage_saved.has_value())
...
Tensor & VariableType::exp_out(Tensor & out, const Tensor & self) const {
...
Tensor & VariableType::eye_out(Tensor & out, int64_t n) const {
...
Tensor & VariableType::eye_out(Tensor & out, int64_t n, int64_t m) const {
  RECORD_FUNCTION("eye_out", std::vector<c10::IValue>({out}), Function::peek_at_next_sequence_nr());
  auto& out_ = unpack(out, "out", 0);
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
...
Tensor VariableType::fbgemm_linear_int8_weight(const Tensor & input, const Tensor & weight, const Tensor & packed, const Tensor & col_offsets, Scalar weight_scale, Scalar weight_zero_point, const Tensor & bias) const {
...
Tensor VariableType::flip(const Tensor & self, IntArrayRef dims) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->flip(self_, dims);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::fmod(const Tensor & self, Scalar other) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->fmod(self_, other);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::fmod(const Tensor & self, const Tensor & other) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->fmod(self_, other_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
std::tuple<Tensor,Tensor> VariableType::fractional_max_pool2d(const Tensor & self, IntArrayRef kernel_size, IntArrayRef output_size, const Tensor & random_samples) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->fractional_max_pool2d(self_, kernel_size, output_size, random_samples_);
  })();
  std::tie(result0, result1) = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::fractional_max_pool2d_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, IntArrayRef kernel_size, IntArrayRef output_size, const Tensor & indices) const {
...
std::tuple<Tensor &,Tensor &> VariableType::fractional_max_pool3d_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef kernel_size, IntArrayRef output_size, const Tensor & random_samples) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->fractional_max_pool3d_out(output_, indices_, self_, kernel_size, output_size, random_samples_);
  }
  #ifndef NDEBUG
  if (output__storage_saved.has_value())
    AT_ASSERT(output__storage_saved.value().is_alias_of(output_.storage()));
...
Tensor VariableType::frobenius_norm(const Tensor & self, IntArrayRef dim, bool keepdim) const {
  RECORD_FUNCTION("frobenius_norm", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
...
Tensor VariableType::from_file(std::string filename, c10::optional<bool> shared, c10::optional<int64_t> size, const TensorOptions & options) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->from_file(filename, shared, size, options_);
  })();
  auto result = as_variable(tmp);
  if (tracer_state) {
    jit::tracer::setTracingState(std::move(tracer_state));
...
std::tuple<Tensor &,Tensor &> VariableType::geqrf_out(Tensor & a, Tensor & tau, const Tensor & self) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->geqrf_out(a_, tau_, self_);
  }
  #ifndef NDEBUG
  if (a__storage_saved.has_value())
    AT_ASSERT(a__storage_saved.value().is_alias_of(a_.storage()));
...
Tensor & VariableType::ger_out(Tensor & out, const Tensor & self, const Tensor & vec2) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->ger_out(out_, self_, vec2_);
  }
  #ifndef NDEBUG
  if (out__storage_saved.has_value())
    AT_ASSERT(out__storage_saved.value().is_alias_of(out_.storage()));
...
Tensor VariableType::hardtanh(const Tensor & self, Scalar min_val, Scalar max_val) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->hardtanh(self_, min_val, max_val);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::int_repr(const Tensor & self) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->int_repr(self_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::isnan(const Tensor & self) const {
...
Tensor VariableType::l1_loss_backward(const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->l1_loss_backward(grad_output_, self_, target_, reduction);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (grad_output__storage_saved.has_value())
...
Tensor & VariableType::lgamma_out(Tensor & out, const Tensor & self) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->lgamma_out(out_, self_);
  }
  #ifndef NDEBUG
  if (out__storage_saved.has_value())
    AT_ASSERT(out__storage_saved.value().is_alias_of(out_.storage()));
...
Tensor VariableType::linspace(Scalar start, Scalar end, int64_t steps, const TensorOptions & options) const {
...
Tensor & VariableType::log1p_out(Tensor & out, const Tensor & self) const {
...
std::tuple<Tensor,Tensor> VariableType::log_sigmoid_forward(const Tensor & self) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->log_sigmoid_forward(self_);
  })();
  std::tie(output, buffer) = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::lu_solve_out(Tensor & out, const Tensor & self, const Tensor & LU_data, const Tensor & LU_pivots) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->lu_solve_out(out_, self_, LU_data_, LU_pivots_);
  }
  #ifndef NDEBUG
  if (out__storage_saved.has_value())
    AT_ASSERT(out__storage_saved.value().is_alias_of(out_.storage()));
...
Tensor VariableType::masked_fill(const Tensor & self, const Tensor & mask, Scalar value) const {
...
Tensor VariableType::masked_fill(const Tensor & self, const Tensor & mask, const Tensor & value) const {
  RECORD_FUNCTION("masked_fill", std::vector<c10::IValue>({self, mask, value}), Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
...
Tensor VariableType::masked_scatter(const Tensor & self, const Tensor & mask, const Tensor & source) const {
...
Tensor VariableType::max_pool1d(const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, bool ceil_mode) const {
...
std::tuple<Tensor,Tensor> VariableType::max_pool2d_with_indices(const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, bool ceil_mode) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->max_pool2d_with_indices(self_, kernel_size, stride, padding, dilation, ceil_mode);
  })();
  std::tie(result0, result1) = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::max_pool2d_with_indices_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, bool ceil_mode, const Tensor & indices) const {
...
std::tuple<Tensor &,Tensor &> VariableType::max_pool3d_with_indices_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, bool ceil_mode) const {
  RECORD_FUNCTION("max_pool3d_with_indices_out", std::vector<c10::IValue>({output, indices, self}), Function::peek_at_next_sequence_nr());
  auto& output_ = unpack(output, "output", 0);
  auto& indices_ = unpack(indices, "indices", 1);
  auto& self_ = unpack(self, "self", 2);
  std::shared_ptr<Function> grad_fn;
...
Tensor VariableType::max_unpool3d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & indices, IntArrayRef output_size, IntArrayRef stride, IntArrayRef padding) const {
...
Tensor VariableType::mean(const Tensor & self, ScalarType dtype) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->mean(self_, dtype);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::mean(const Tensor & self, IntArrayRef dim, bool keepdim, ScalarType dtype) const {
  RECORD_FUNCTION("mean", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->mean(self_, dim, keepdim, dtype);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::mean(const Tensor & self, IntArrayRef dim, bool keepdim) const {
  RECORD_FUNCTION("mean", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->mean(self_, dim, keepdim);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::mean(const Tensor & self, IntArrayRef dim, ScalarType dtype) const {
  RECORD_FUNCTION("mean", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->mean(self_, dim, dtype);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
std::tuple<Tensor,Tensor> VariableType::median(const Tensor & self, int64_t dim, bool keepdim) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->median(self_, dim, keepdim);
  })();
...
std::tuple<Tensor,Tensor,Tensor> VariableType::miopen_batch_norm_backward(const Tensor & input, const Tensor & grad_output, const Tensor & weight, const Tensor & running_mean, const Tensor & running_var, const Tensor & save_mean, const Tensor & save_var, double epsilon) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->miopen_batch_norm_backward(input_, grad_output_, weight_, running_mean_, running_var_, save_mean_, save_var_, epsilon);
  })();
  std::tie(result0, result1, result2) = as_variable(tmp);
  #ifndef NDEBUG
  if (input__storage_saved.has_value())
...
Tensor VariableType::miopen_depthwise_convolution(const Tensor & self, const Tensor & weight, const Tensor & bias, IntArrayRef padding, IntArrayRef stride, IntArrayRef dilation, int64_t groups, bool benchmark, bool deterministic) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->miopen_depthwise_convolution(self_, weight_, bias_, padding, stride, dilation, groups, benchmark, deterministic);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::mkldnn_max_pool2d(const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, bool ceil_mode) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->mkldnn_max_pool2d(self_, kernel_size, stride, padding, dilation, ceil_mode);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::mm_out(Tensor & out, const Tensor & self, const Tensor & mat2) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->mm_out(out_, self_, mat2_);
  }
  #ifndef NDEBUG
  if (out__storage_saved.has_value())
    AT_ASSERT(out__storage_saved.value().is_alias_of(out_.storage()));
...
Tensor VariableType::multi_margin_loss(const Tensor & self, const Tensor & target, Scalar p, Scalar margin, const Tensor & weight, int64_t reduction) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->multi_margin_loss(self_, target_, p, margin, weight_, reduction);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
std::tuple<Tensor,Tensor> VariableType::nll_loss2d_forward(const Tensor & self, const Tensor & target, const Tensor & weight, int64_t reduction, int64_t ignore_index) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->nll_loss2d_forward(self_, target_, weight_, reduction, ignore_index);
  })();
  std::tie(output, total_weight) = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
std::tuple<Tensor,Tensor> VariableType::nll_loss_forward(const Tensor & self, const Tensor & target, const Tensor & weight, int64_t reduction, int64_t ignore_index) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->nll_loss_forward(self_, target_, weight_, reduction, ignore_index);
  })();
  std::tie(output, total_weight) = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::ones(IntArrayRef size, const TensorOptions & options) const {
...
Tensor VariableType::polygamma(int64_t n, const Tensor & self) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->polygamma(n, self_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::pow(const Tensor & self, Scalar exponent) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->pow(self_, exponent);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::pow(const Tensor & self, const Tensor & exponent) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->pow(self_, exponent_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::pow(Scalar self, const Tensor & exponent) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->pow(self, exponent_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (exponent__storage_saved.has_value())
...
Tensor VariableType::prelu(const Tensor & self, const Tensor & weight) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->prelu(self_, weight_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::prod(const Tensor & self, ScalarType dtype) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->prod(self_, dtype);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::prod(const Tensor & self, int64_t dim, bool keepdim, ScalarType dtype) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->prod(self_, dim, keepdim, dtype);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::prod(const Tensor & self, int64_t dim, bool keepdim) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->prod(self_, dim, keepdim);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::prod(const Tensor & self, int64_t dim, ScalarType dtype) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->prod(self_, dim, dtype);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::rand_like(const Tensor & self, const TensorOptions & options) const {
  RECORD_FUNCTION("rand_like", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
...
Tensor VariableType::randint(int64_t high, IntArrayRef size, const TensorOptions & options) const {
...
Tensor VariableType::randint(int64_t high, IntArrayRef size, Generator * generator, const TensorOptions & options) const {
  RECORD_FUNCTION("randint", std::vector<c10::IValue>({}), Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
...
Tensor VariableType::randint(int64_t low, int64_t high, IntArrayRef size, const TensorOptions & options) const {
  RECORD_FUNCTION("randint", std::vector<c10::IValue>({}), Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
...
Tensor VariableType::randint(int64_t low, int64_t high, IntArrayRef size, Generator * generator, const TensorOptions & options) const {
  RECORD_FUNCTION("randint", std::vector<c10::IValue>({}), Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
...
Tensor VariableType::randn_like(const Tensor & self, const TensorOptions & options) const {
  RECORD_FUNCTION("randn_like", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
...
Tensor VariableType::randperm(int64_t n, const TensorOptions & options) const {
...
Tensor VariableType::randperm(int64_t n, Generator * generator, const TensorOptions & options) const {
  RECORD_FUNCTION("randperm", std::vector<c10::IValue>({}), Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
...
Tensor VariableType::reflection_pad2d_backward(const Tensor & grad_output, const Tensor & self, IntArrayRef padding) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->reflection_pad2d_backward(grad_output_, self_, padding);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (grad_output__storage_saved.has_value())
...
Tensor VariableType::repeat_interleave(const Tensor & repeats) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->repeat_interleave(repeats_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
...
Tensor VariableType::repeat_interleave(const Tensor & self, const Tensor & repeats, c10::optional<int64_t> dim) const {
...
Tensor VariableType::repeat_interleave(const Tensor & self, int64_t repeats, c10::optional<int64_t> dim) const {
...
Tensor VariableType::replication_pad1d_backward(const Tensor & grad_output, const Tensor & self, IntArrayRef padding) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->replication_pad1d_backward(grad_output_, self_, padding);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (grad_output__storage_saved.has_value())
...
Tensor VariableType::replication_pad2d(const Tensor & self, IntArrayRef padding) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->replication_pad2d(self_, padding);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::replication_pad2d_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, IntArrayRef padding) const {
...
Tensor & VariableType::replication_pad3d_out(Tensor & out, const Tensor & self, IntArrayRef padding) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->replication_pad3d_out(out_, self_, padding);
  }
  #ifndef NDEBUG
  if (out__storage_saved.has_value())
    AT_ASSERT(out__storage_saved.value().is_alias_of(out_.storage()));
...
Tensor VariableType::s_native_addmm(const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->s_native_addmm(self_, mat1_, mat2_, beta, alpha);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::scalar_tensor(Scalar s, const TensorOptions & options) const {
...
Tensor & VariableType::set_(Tensor & self, Storage source, int64_t storage_offset, IntArrayRef size, IntArrayRef stride) const {
  RECORD_FUNCTION("set_", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
...
Tensor & VariableType::sigmoid_out(Tensor & out, const Tensor & self) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->sigmoid_out(out_, self_);
  }
  #ifndef NDEBUG
  if (out__storage_saved.has_value())
    AT_ASSERT(out__storage_saved.value().is_alias_of(out_.storage()));
...
Tensor & VariableType::sign_out(Tensor & out, const Tensor & self) const {
...
Tensor VariableType::smooth_l1_loss(const Tensor & self, const Tensor & target, int64_t reduction) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->smooth_l1_loss(self_, target_, reduction);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::soft_margin_loss_backward(const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->soft_margin_loss_backward(grad_output_, self_, target_, reduction);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (grad_output__storage_saved.has_value())
...
Tensor VariableType::softplus_backward(const Tensor & grad_output, const Tensor & self, Scalar beta, Scalar threshold, const Tensor & output) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->softplus_backward(grad_output_, self_, beta, threshold, output_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (grad_output__storage_saved.has_value())
...
std::tuple<Tensor &,Tensor &> VariableType::solve_out(Tensor & solution, Tensor & lu, const Tensor & self, const Tensor & A) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->solve_out(solution_, lu_, self_, A_);
  }
  #ifndef NDEBUG
...
Tensor VariableType::sparse_coo_tensor(IntArrayRef size, const TensorOptions & options) const {
...
Tensor VariableType::sparse_coo_tensor(const Tensor & indices, const Tensor & values, const TensorOptions & options) const {
...
Tensor VariableType::sparse_coo_tensor(const Tensor & indices, const Tensor & values, IntArrayRef size, const TensorOptions & options) const {
  RECORD_FUNCTION("sparse_coo_tensor", std::vector<c10::IValue>({indices, values}), Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
...
Tensor & VariableType::sparse_resize_(Tensor & self, IntArrayRef size, int64_t sparse_dim, int64_t dense_dim) const {
...
Tensor & VariableType::sqrt_out(Tensor & out, const Tensor & self) const {
...
Tensor & VariableType::tan_out(Tensor & out, const Tensor & self) const {
...
Tensor VariableType::thnn_col2im(const Tensor & self, IntArrayRef output_size, IntArrayRef kernel_size, IntArrayRef dilation, IntArrayRef padding, IntArrayRef stride) const {
  RECORD_FUNCTION("thnn_col2im", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->thnn_col2im(self_, output_size, kernel_size, dilation, padding, stride);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::thnn_conv2d_out(Tensor & out, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, const Tensor & bias, IntArrayRef stride, IntArrayRef padding) const {
...
std::tuple<Tensor,Tensor> VariableType::thnn_conv_depthwise2d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, std::array<bool,2> output_mask) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->thnn_conv_depthwise2d_backward(grad_output_, self_, weight_, kernel_size, stride, padding, dilation, output_mask);
  })();
  std::tie(grad_input, grad_weight) = as_variable(tmp);
  #ifndef NDEBUG
  if (grad_output__storage_saved.has_value())
...
Tensor & VariableType::thnn_conv_depthwise2d_forward_out(Tensor & out, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, const Tensor & bias, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->thnn_conv_depthwise2d_forward_out(out_, self_, weight_, kernel_size, bias_, stride, padding, dilation);
  }
  #ifndef NDEBUG
  if (out__storage_saved.has_value())
    AT_ASSERT(out__storage_saved.value().is_alias_of(out_.storage()));
...
std::tuple<Tensor,Tensor,Tensor> VariableType::thnn_conv_dilated2d_forward(const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, const Tensor & bias, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation) const {
  RECORD_FUNCTION("thnn_conv_dilated2d_forward", std::vector<c10::IValue>({self, weight, bias}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  auto& weight_ = unpack(weight, "weight", 1);
  auto bias_ = unpack_opt(bias, "bias", 3);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->thnn_conv_dilated2d_forward(self_, weight_, kernel_size, bias_, stride, padding, dilation);
  })();
  std::tie(output, columns, ones) = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
std::tuple<Tensor,Tensor,Tensor> VariableType::thnn_conv_dilated3d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, const Tensor & columns, const Tensor & ones, std::array<bool,3> output_mask) const {
  RECORD_FUNCTION("thnn_conv_dilated3d_backward", std::vector<c10::IValue>({grad_output, self, weight, columns, ones}), Function::peek_at_next_sequence_nr());
  auto& grad_output_ = unpack(grad_output, "grad_output", 0);
  auto& self_ = unpack(self, "self", 1);
  auto& weight_ = unpack(weight, "weight", 2);
  auto& columns_ = unpack(columns, "columns", 7);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->thnn_conv_dilated3d_backward(grad_output_, self_, weight_, kernel_size, stride, padding, dilation, columns_, ones_, output_mask);
  })();
  std::tie(grad_input, grad_weight, grad_bias) = as_variable(tmp);
  #ifndef NDEBUG
  if (grad_output__storage_saved.has_value())
...
std::tuple<Tensor &,Tensor &,Tensor &> VariableType::thnn_conv_dilated3d_forward_out(Tensor & output, Tensor & columns, Tensor & ones, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, const Tensor & bias, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation) const {
  RECORD_FUNCTION("thnn_conv_dilated3d_forward_out", std::vector<c10::IValue>({output, columns, ones, self, weight, bias}), Function::peek_at_next_sequence_nr());
  auto& output_ = unpack(output, "output", 0);
  auto& columns_ = unpack(columns, "columns", 1);
  auto& ones_ = unpack(ones, "ones", 2);
  auto& self_ = unpack(self, "self", 3);
...
std::tuple<Tensor,Tensor,Tensor> VariableType::thnn_conv_transpose3d_forward(const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, const Tensor & bias, IntArrayRef stride, IntArrayRef padding, IntArrayRef output_padding, IntArrayRef dilation) const {
  RECORD_FUNCTION("thnn_conv_transpose3d_forward", std::vector<c10::IValue>({self, weight, bias}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  auto& weight_ = unpack(weight, "weight", 1);
  auto bias_ = unpack_opt(bias, "bias", 3);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->thnn_conv_transpose3d_forward(self_, weight_, kernel_size, bias_, stride, padding, output_padding, dilation);
  })();
  std::tie(output_return, finput, fgrad_input) = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
    AT_ASSERT(self__storage_saved.value().is_alias_of(self_.storage()));
  if (self__impl_saved) AT_ASSERT(self__impl_saved == self_.getIntrusivePtr());
  ...
  return std::make_tuple(std::move(output_return), std::move(finput), std::move(fgrad_input));
}
Tensor VariableType::thnn_im2col(const Tensor & self, IntArrayRef kernel_size, IntArrayRef dilation, IntArrayRef padding, IntArrayRef stride) const {
  RECORD_FUNCTION("thnn_im2col", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->thnn_im2col(self_, kernel_size, dilation, padding, stride);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::threshold_out(Tensor & out, const Tensor & self, Scalar threshold, Scalar value) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->threshold_out(out_, self_, threshold, value);
  }
  #ifndef NDEBUG
  if (out__storage_saved.has_value())
    AT_ASSERT(out__storage_saved.value().is_alias_of(out_.storage()));
...
Tensor VariableType::to_mkldnn_backward(const Tensor & grad, const Tensor & input) const {
...
Tensor & VariableType::tril_out(Tensor & out, const Tensor & self, int64_t diagonal) const {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    baseType->tril_out(out_, self_, diagonal);
  }
  #ifndef NDEBUG
  if (out__storage_saved.has_value())
    AT_ASSERT(out__storage_saved.value().is_alias_of(out_.storage()));
...
Tensor VariableType::triu(const Tensor & self, int64_t diagonal) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->triu(self_, diagonal);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::triu_indices(int64_t row, int64_t col, int64_t offset, const TensorOptions & options) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->triu_indices(row, col, offset, options_);
  })();
  auto result = as_variable(tmp);
  if (tracer_state) {
    jit::tracer::setTracingState(std::move(tracer_state));
...
std::tuple<Tensor,Tensor,Tensor> VariableType::unique_dim(const Tensor & self, int64_t dim, bool sorted, bool return_inverse, bool return_counts) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->unique_dim(self_, dim, sorted, return_inverse, return_counts);
  })();
  std::tie(result0, result1, result2) = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::unsqueeze(const Tensor & self, int64_t dim) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->unsqueeze(self_, dim);
  })();
  auto result = as_view(self, tmp, true);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::upsample_bicubic2d(const Tensor & self, IntArrayRef output_size, bool align_corners) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->upsample_bicubic2d(self_, output_size, align_corners);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::upsample_bicubic2d_backward_out(Tensor & grad_input, const Tensor & grad_output, IntArrayRef output_size, IntArrayRef input_size, bool align_corners) const {
...
Tensor VariableType::upsample_nearest3d_backward(const Tensor & grad_output, IntArrayRef output_size, IntArrayRef input_size) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->upsample_nearest3d_backward(grad_output_, output_size, input_size);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (grad_output__storage_saved.has_value())
...
Tensor VariableType::upsample_trilinear3d(const Tensor & self, IntArrayRef output_size, bool align_corners) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->upsample_trilinear3d(self_, output_size, align_corners);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::upsample_trilinear3d_backward_out(Tensor & grad_input, const Tensor & grad_output, IntArrayRef output_size, IntArrayRef input_size, bool align_corners) const {
...
Tensor & VariableType::zeros_out(Tensor & out, IntArrayRef size) const {
