...
(cl:defclass <GimbalAngle> (roslisp-msg-protocol:ros-message)
  ((yaw_mode
   ...
   (pitch_angle
    ...
    :initform 0.0)
   (cal_yaw_angle
    :reader cal_yaw_angle
    :initarg :cal_yaw_angle
    :type cl:float
    :initform 0.0))
)
...
(cl:ensure-generic-function 'cal_yaw_angle-val :lambda-list '(m))
(cl:defmethod cal_yaw_angle-val ((m <GimbalAngle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roborts_msgs-msg:cal_yaw_angle-val is deprecated.  Use roborts_msgs-msg:cal_yaw_angle instead.")
  (cal_yaw_angle m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <GimbalAngle>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'pitch_angle))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'cal_yaw_angle))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GimbalAngle>) istream)
  "Deserializes a message object of type '<GimbalAngle>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'cal_yaw_angle) (roslisp-utils:decode-double-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GimbalAngle>)))
  ...
  "3150042c4cfc7a60883fbfd3f7939a62")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GimbalAngle)))
  "Returns md5sum for a message object of type 'GimbalAngle"
  "3150042c4cfc7a60883fbfd3f7939a62")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GimbalAngle>)))
  ...
  (cl:format cl:nil "#gimbal feedback angle data~%bool yaw_mode~%bool pitch_mode~%float64 yaw_angle~%float64 pitch_angle~%float64 cal_yaw_angle~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GimbalAngle)))
  "Returns full string definition for message of type 'GimbalAngle"
  (cl:format cl:nil "#gimbal feedback angle data~%bool yaw_mode~%bool pitch_mode~%float64 yaw_angle~%float64 pitch_angle~%float64 cal_yaw_angle~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <GimbalAngle>))
  ...
  (cl:list 'GimbalAngle
    ...
    (cl:cons ':cal_yaw_angle (cal_yaw_angle msg))
))
