...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ArmorsPos>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'armor_0))))
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'armor_1))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'robot_A))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'robot_B))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'pose_A))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'pose_B))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ArmorsPos>) istream)
  ...
  (cl:setf (cl:slot-value msg 'armor_0) (cl:make-array __ros_arr_len))
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'armor_1) (cl:make-array __ros_arr_len))
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'robot_A) (cl:make-array __ros_arr_len))
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'robot_B) (cl:make-array __ros_arr_len))
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'pose_A) (cl:make-array __ros_arr_len))
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'pose_B) (cl:make-array __ros_arr_len))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ArmorsPos>)))
  ...
  "d88b6c677bb940ddc0838672e90bcca6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ArmorsPos)))
  "Returns md5sum for a message object of type 'ArmorsPos"
  "d88b6c677bb940ddc0838672e90bcca6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ArmorsPos>)))
  ...
  (cl:format cl:nil "uint8 num_armor~%float32[] armor_0~%float32[] armor_1~%uint8[] id~%uint8[] state~%float32[] robot_A~%float32[] robot_B~%float32[] pose_A~%float32[] pose_B~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ArmorsPos)))
  "Returns full string definition for message of type 'ArmorsPos"
  (cl:format cl:nil "uint8 num_armor~%float32[] armor_0~%float32[] armor_1~%uint8[] id~%uint8[] state~%float32[] robot_A~%float32[] robot_B~%float32[] pose_A~%float32[] pose_B~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ArmorsPos>))
  (cl:+ 0
     1
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'armor_0) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'armor_1) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'robot_A) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'robot_B) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'pose_A) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'pose_B) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
))
