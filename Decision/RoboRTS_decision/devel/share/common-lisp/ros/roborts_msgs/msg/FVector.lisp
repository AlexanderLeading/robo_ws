...
(cl:defmethod cl:initialize-instance :after ((m <FVector>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FVector)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roborts_msgs-msg:<FVector> is deprecated: use roborts_msgs-msg:FVector instead.")))

(cl:ensure-generic-function 'vector-val :lambda-list '(m))
(cl:defmethod vector-val ((m <FVector>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roborts_msgs-msg:vector-val is deprecated.  Use roborts_msgs-msg:vector instead.")
  (vector m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FVector>)))
  ...
  (cl:format cl:nil "float32[] vector~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FVector)))
  "Returns full string definition for message of type 'FVector"
  (cl:format cl:nil "float32[] vector~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <FVector>))
  (cl:+ 0
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'vector) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
))
