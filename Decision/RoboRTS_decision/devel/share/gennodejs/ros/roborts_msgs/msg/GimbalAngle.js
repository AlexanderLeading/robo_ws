...
class GimbalAngle {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('cal_yaw_angle')) {
        this.cal_yaw_angle = initObj.cal_yaw_angle
      }
      else {
        this.cal_yaw_angle = 0.0;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [cal_yaw_angle]
    bufferOffset = _serializer.float64(obj.cal_yaw_angle, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [cal_yaw_angle]
    data.cal_yaw_angle = _deserializer.float64(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return '3150042c4cfc7a60883fbfd3f7939a62';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.cal_yaw_angle !== undefined) {
      resolved.cal_yaw_angle = msg.cal_yaw_angle;
    }
    else {
      resolved.cal_yaw_angle = 0.0
    }
