...
class FVector {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float32(obj.vector, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FVector(null);
    // Deserialize message field [vector]
    data.vector = _arrayDeserializer.float32(buffer, bufferOffset, null)
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += 4 * object.vector.length;
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FVector(null);
